...
const jellyGemsObj  = {
        amethyst : {
            name: 'Amethysts',
            id: 'Amethyst',
            description: 'Amethysts are thought to be a source of power and wisedom. They are attatched to serenity, trust and grace.',
        ...
        amber : {
            name: 'Amber',
            id: 'Amber',
            description: 'Amber is tree resin that can range from 30 to 90 minnion years old! This resin is generally found in ancient evergreen trees. Amber is the stone of courage, and has long been given to travellers to keep them safe on long journeys.', 
        ...
        emerald : {
            name: 'Emeralds',
            id: 'Emerald',
            description: 'Throughout time, emeralds have been known as a symbol of truth and love, as well as eloquence, wit and forsight.', 
